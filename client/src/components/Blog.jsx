...
function Blog() {
  ...
  return (
    ...
    <div className='container'>
      <div className='blog-title blog-top' ><h5>Our Blogs</h5></div>
            ...
            <div className="modal-dialog modal-xl">
                ...
                <div className="modal-body">
                    ...
                    <ol type='1'>
                        ...
                        <li><b>Preventive Measures:</b>
                            <ol type='a'>
                                <li>Sun Protection</li>
                                <li>Healthy Lifestyle</li>
                                <li>Stress Management</li>
                                <li>Gentle Skincare</li>
            ...
            <div className="modal-dialog modal-xl">
                ...
                <div className="modal-body">
                    ...
                    <ol type='1'>
                        ...
                        <li><b>Transformative Impact on Lives:</b>
                            <ol type='a'>
                                <li>Life-Saving Interventions</li>
                                <li>Pain Relief and Functional Restoration:</li>
